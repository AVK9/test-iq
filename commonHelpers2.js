...
`;function M(e){const i=document.getElementById("progress-bar"),c=e/b.length*100;i.style.width=`${c}%`}const N="/test-iq/assets/call-BdpohKNc.svg",$=x.create({baseURL:"https://swapi.dev/api/people/1/"}),A=async()=>{const{data:e}=await $.get("");return e},H=`<div class="rezult-container">
